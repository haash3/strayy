        ...
        <div className='about-us '>
            ...
            <div className='aboutUs-text-grid rounded-[50px]'>
              ...
              <div className='aboutUs-text-box'>
                <div>
                  <h2 className='font-oswald uppercase text-[1.5rem] font-bold
                  ...
                  <p className='font-dmsans font-bold text-left'>
                    ...
                    putting an end to dead stock, unconventional waste and 
                    more.
                  </p>
                </div>
                <div>
                  ...
                  <p className='font-dmsans font-bold text-left'>
                    We're on a mission to empower create 
                    independence in a commercial world and incredible.
                  </p>
                </div>
