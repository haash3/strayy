      ...
      <div className="goal-section">
        <div>
          ...
          <p className="font-dmsans text-[1.5rem] font-semibold text-left py-2 px-4 text-[#9AAF70]">
            ...
            high-quality clothing that aligns with environmental and ethical
            standards. Through innovation and dedication, we strive to create a
            positive impact on both people and the planet, fostering a more
